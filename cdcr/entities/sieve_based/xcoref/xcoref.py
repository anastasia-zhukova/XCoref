...
from cdcr.entities.sieve_based.xcoref.steps.step2_3 import XCorefStep3
from cdcr.entities.sieve_based.xcoref.steps.step2_4 import XCorefStep4
from cdcr.entities.const_dict_global import *
from cdcr.entities.sieve_based.xcoref.entity_xcoref import EntityXCoref


class XCoref(SieveBasedApproach):
    """
