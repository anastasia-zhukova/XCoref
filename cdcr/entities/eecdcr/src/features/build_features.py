...
from cdcr.entities.eecdcr.src.features.swirl_parsing import parse_swirl_output
from cdcr.entities.eecdcr.src.features.allen_srl_reader import read_srl
from cdcr.entities.eecdcr.src.features.create_elmo_embeddings import *
from cdcr.entities.eecdcr.src.shared.classes import EventMention, EntityMention
from cdcr.entities.eecdcr.src.features.extraction_utils import *
...
def match_allen_srl_structures(dataset, srl_data, config, is_gold):
    '''
