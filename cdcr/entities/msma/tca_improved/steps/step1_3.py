...
class TCAStep3(MergeStep):
    ...
    def __init__(self, step, docs, entity_dict, ent_preprocessor, model):
        ...
        super().__init__(MSMA1_3, step, docs.configuration.entity_identifier_config, entity_dict, ent_preprocessor,
                         model)
        ...
        for ent in list(self.entity_dict.values()):
            ...
            compound_phrases = [self.model.optimize_phrase(MergeStep.words_to_tokens(list(phrase), ent.token_dict),
