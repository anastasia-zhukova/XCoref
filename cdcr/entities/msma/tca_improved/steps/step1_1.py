...
class TCAStep1(MergeStep):
    ...
    def __init__(self, step, docs, entity_dict, ent_preprocessor, model):
        ...
        super().__init__(MSMA1_1, step, docs.configuration.entity_identifier_config, entity_dict, ent_preprocessor,
                         model)
        ...
        for ent in list(self.entity_dict.values()):
            ...
            cleaned_heads = self.model.optimize_phrase(MergeStep.words_to_tokens(list(ent.headwords_cand_tree), ent.token_dict),
                                               True)
