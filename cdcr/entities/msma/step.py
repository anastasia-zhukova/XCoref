...
from typing import *
from cdcr.entities.msma.params_msma import MSMAParams
...
class MergeStep:
    """
    MergeStep is a general class for implementation of merge steps in multi-step merging approach (MSMA).
    """

    logger = LOGGER

    def __init__(self, name: str, code: str, config: MSMAParams, entity_dict: Dict[str, Entity],
                 ent_preprocessor: EntityPreprocessorMSMA,
                 model=None):
        """
