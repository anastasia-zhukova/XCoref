...
class EntityPreprocessorMSMA(EntityPreprocessor):
    """
    A class with custom process of entity preprocessing and constructing of entity_dict created for MSMA.
    """
            ...
            for cand in cand_group:
                ...
                if cand.annot_text == "" or cand.annot_text is None:
                    ...
                    if (JJ in cand.head_token.pos and cand.head_token.ner == NON_NER and
                        len([t.word for t in cand.tokens if EntityPreprocessorMSMA.not_stopword(t.word)]) == 1) \
